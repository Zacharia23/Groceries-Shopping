...
class FailedDialog extends StatefulWidget {
  ...
  final int code;
  const FailedDialog({this.code = 0, this.message = '', Key? key}) : super(key: key);

  @override
  _FailedDialogState createState() => _FailedDialogState();
}

class _FailedDialogState extends State<FailedDialog> with TickerProviderStateMixin {
